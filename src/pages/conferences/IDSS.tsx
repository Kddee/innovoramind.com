...
import { 
  ...
  Globe, LayoutList, Database, Activity, BookOpen, Mic, FileText, Image as ImageIcon, Map, LineChart 
} from 'lucide-react';
            ...
            >
              <div className="flex items-center space-x-4 mb-6">
                ...
                <div className="flex -space-x-2">
                  {[1, 2, 3, 4].map((i) => (
                    <img key={i} className="w-8 h-8 rounded-full border-2 border-slate-900" src={`https://i.pravatar.cc/100?img=${i+50}`} alt="Attendee" />
                  ))}
                  <div className="w-8 h-8 rounded-full border-2 border-slate-900 bg-secondary flex items-center justify-center text-[10px] font-bold text-white">+2.5k</div>
                </div>
              </div>

              <h1 className="font-display text-4xl sm:text-5xl lg:text-7xl font-bold text-white mb-6 leading-tight drop-shadow-lg">
                Int. Data Science <span className="text-transparent bg-clip-text bg-gradient-to-r from-secondary to-accent">Summit</span>
              </h1>
              <p className="text-xl sm:text-2xl text-slate-300 font-medium mb-10 max-w-2xl leading-relaxed">
                Transforming raw information into actionable intelligence. Explore big data, analytics, and predictive modeling at scale.
              </p>
              ...
              <div className="flex flex-wrap gap-4">
                <div className="flex items-center px-5 py-3 rounded-xl bg-white/10 border border-white/20 backdrop-blur-md">
                  ...
                  <span className="text-white font-medium">August 16 - 18, 2026</span>
                </div>
                <div className="flex items-center px-5 py-3 rounded-xl bg-white/10 border border-white/20 backdrop-blur-md">
      ...
      <div className="bg-card border-b border-border/50">
        <div className="container-custom">
          <div className="flex flex-wrap items-center justify-center gap-8 md:gap-16 py-10 opacity-60 grayscale hover:grayscale-0 transition-all duration-500">
             <div className="flex items-center space-x-2 text-xl font-bold font-display"><Database className="w-8 h-8 text-primary"/><span>DataCore Inc</span></div>
             <div className="flex items-center space-x-2 text-xl font-bold font-display"><Globe className="w-8 h-8 text-secondary"/><span>Global Analytics Org</span></div>
             <div className="flex items-center space-x-2 text-xl font-bold font-display"><LineChart className="w-8 h-8 text-accent"/><span>Insight Group</span></div>
          </div>
        </div>
      </div>
        ...
        <div className="container-custom space-y-24">
              ...
              >
                ...
                <div className="prose prose-lg dark:prose-invert max-w-none text-muted-foreground mt-8 text-justify">
                  <p className="text-xl leading-relaxed mb-6 font-medium text-foreground/80">
                    The International Data Science Summit (IDSS) is the foremost event for statisticians, data engineers, and AI practitioners looking to leverage big data.
                  </p>
                  
                  <div className="grid md:grid-cols-2 gap-8 my-10">
                    <img src="https://images.unsplash.com/photo-1551434678-e076c223a692?auto=format&fit=crop&q=80&w=700" className="rounded-2xl shadow-lg border border-border" alt="Working with Data" />
                    <img src="https://images.unsplash.com/photo-1543286386-713bdd548da4?auto=format&fit=crop&q=80&w=700" className="rounded-2xl shadow-lg border border-border" alt="Charts" />
                  </div>

                  <p className="mb-6">
                    Held physically at our primary venue and virtually around the globe, IDSS brings together the sharpest minds to discuss data pipelines, visualization tools, and ethics in AI models. Participate in hackathons and masterclasses led by industry pioneers.
                  </p>
                  <p>
                    Whether you are an academic looking to present your latest findings or a corporate IT leader seeking innovative solutions, IDSS provides unparalleled networking opportunities in the heart of the world's financial and tech capital.
                  </p>
                </div>
              </motion.div>
            </div>
            ...
            <div className="space-y-8">
              ...
              >
                ...
                <div className="relative z-10">
                  ...
                  <img src="https://images.unsplash.com/photo-1543286386-713bdd548da4?auto=format&fit=crop&q=80&w=500" className="w-full h-40 object-cover rounded-xl mb-6 shadow-md" alt="Register" />

                  <p className="text-sm text-muted-foreground mb-6">
                    Secure your spot at IDSS 2026. Choose the participation format that best suits your needs, whether you are presenting research or joining as a listener.
                  </p>
                  ...
                  <a 
                    href="https://docs.google.com/forms/d/e/1FAIpQLSeVigNCB2nfZ9PcrJSdWspxc2I1Op6F6MRTgnUFQQOJiNIqOQ/viewform?usp=publish-editor" 
                    target="_blank" 
          ...
          >
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8 relative">
              ...
              <div className="relative text-center group">
                ...
                <p className="text-secondary font-semibold text-sm mb-2">May 20, 2026</p>
              ...
              <div className="relative text-center group">
                ...
                <p className="text-accent font-semibold text-sm mb-2">June 15, 2026</p>
              ...
              <div className="relative text-center group">
                ...
                <p className="text-primary font-semibold text-sm mb-2">July 15, 2026</p>
              ...
              <div className="relative text-center group">
                ...
                <p className="text-emerald-500 font-semibold text-sm mb-2">August 16 - 18, 2026</p>
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            >
              ...
              <p className="text-muted-foreground mb-6 leading-relaxed">
                All accepted and registered papers will be published in the official IDSS Conference Proceedings. Extensively reviewed papers demonstrating exceptional methodology will be submitted for indexing in major academic databases including <strong>Scopus, Web of Science, and Google Scholar</strong>.
              </p>
            ...
            >
              ...
              <p className="text-muted-foreground mb-6 leading-relaxed">
                IDSS 2026 accommodates various modes of participation to ensure global accessibility. Engage with the community in a format that suits your availability and preference.
              </p>
          ...
          >
            ...
            <p className="text-muted-foreground mb-8 text-lg max-w-3xl">
              Researchers, academicians, and enterprise professionals are invited to submit their abstracts and full papers. Topics of interest cover all aspects of Data Science, but are not limited to the following tracks:
            </p>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              <div className="bg-card border border-border p-6 rounded-2xl shadow-sm hover:shadow-xl hover:border-secondary/50 transition-all group">
                ...
                <h3 className="text-xl font-bold mb-2">Data Warehousing pipelines</h3>
                <p className="text-sm text-muted-foreground">Architecting scalable ETL structures, data lakes, and modern lakehouse integrations.</p>
              </div>
              {/* Track 2 */}
              <div className="bg-card border border-border p-6 rounded-2xl shadow-sm hover:shadow-xl hover:border-accent/50 transition-all group">
                <LineChart className="w-10 h-10 text-accent mb-4 group-hover:scale-110 transition-transform" />
                <h3 className="text-xl font-bold mb-2">Advanced Analytics</h3>
                <p className="text-sm text-muted-foreground">Utilizing statistical methods, R, and Python to extract meaningful BI metrics.</p>
              </div>
              {/* Track 3 */}
              <div className="bg-card border border-border p-6 rounded-2xl shadow-sm hover:shadow-xl hover:border-primary/50 transition-all group">
                ...
                <h3 className="text-xl font-bold mb-2">MLOps & Deployment</h3>
                <p className="text-sm text-muted-foreground">Putting machine learning models into production safely with CI/CD methodologies.</p>
              </div>
              {/* Track 4 */}
              <div className="bg-card border border-border p-6 rounded-2xl shadow-sm hover:shadow-xl hover:border-blue-500/50 transition-all group">
                ...
                <h3 className="text-xl font-bold mb-2">Ethics & Data Privacy</h3>
                <p className="text-sm text-muted-foreground">Complying with GDPR, CCPA, and anonymizing user data while retaining utility.</p>
              </div>
            </div>
          </motion.div>
            ...
            <div className="grid md:grid-cols-2 gap-10 items-center relative z-10">
              <div className="space-y-4">
                {[
                  ...
                  "Networking with Global Data Leaders", 
              ...
              <div className="relative">
                <img src="https://images.unsplash.com/photo-1552664730-d307ca884978?auto=format&fit=crop&q=80&w=700" alt="Networking" className="rounded-2xl shadow-2xl" />
                <div className="absolute -bottom-6 -left-6 bg-accent border-4 border-background text-accent-foreground p-4 rounded-xl shadow-lg">
                  <p className="text-3xl font-black">1500+</p>
          ...
          >
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <div className="bg-background border-2 border-dashed border-border rounded-3xl p-6 flex flex-col items-center justify-center text-center min-h-[300px] hover:bg-muted/50 transition-colors">
                ...
                <a href="https://docs.google.com/forms/d/e/1FAIpQLSeVigNCB2nfZ9PcrJSdWspxc2I1Op6F6MRTgnUFQQOJiNIqOQ/viewform?usp=publish-editor" target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center rounded-xl bg-secondary text-secondary-foreground px-5 py-2.5 text-sm font-semibold hover:bg-secondary/90 transition-colors w-full">
                  Submit Abstract
                </a>
              </div>
            </div>
